...
def openJaegerFiles():
	...
	new_path = os.path.relpath('..//resultsJaeger//20//totNetRec_20.csv', cur_path)
	CSV = readCSV(new_path)
	jaeger20 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsJaeger//40//totNetRec_40.csv', cur_path)
	CSV = readCSV(new_path)
	jaeger40 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsJaeger//60//totNetRec_60.csv', cur_path)
	CSV = readCSV(new_path)
	jaeger60 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsJaeger//80//totNetRec_80.csv', cur_path)
	CSV = readCSV(new_path)
	jaeger80 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsJaeger//100//totNetRec_100.csv', cur_path)
	CSV = readCSV(new_path)
...
def openNoTracing():
	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsNoTracing//20//totNetRec_20.csv', cur_path)
	CSV = readCSV(new_path)
	noTrace20 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsNoTracing//40//totNetRec_40.csv', cur_path)
	CSV = readCSV(new_path)
	noTrace40 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsNoTracing//60//totNetRec_60.csv', cur_path)
	CSV = readCSV(new_path)
	noTrace60 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsNoTracing//80//totNetRec_80.csv', cur_path)
	CSV = readCSV(new_path)
	noTrace80 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsNoTracing//100//totNetRec_100.csv', cur_path)
	CSV = readCSV(new_path)
...
def openZipkin():
	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsZipkin//20//totNetRec_20.csv', cur_path)
	CSV = readCSV(new_path)
	zipkin20 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsZipkin//40//totNetRec_40.csv', cur_path)
	CSV = readCSV(new_path)
	zipkin40 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsZipkin//60//totNetRec_60.csv', cur_path)
	CSV = readCSV(new_path)
	zipkin60 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsZipkin//80//totNetRec_80.csv', cur_path)
	CSV = readCSV(new_path)
	zipkin80 = readToArray(CSV)

	cur_path = os.path.dirname(__file__)
	new_path = os.path.relpath('..//resultsZipkin//100//totNetRec_100.csv', cur_path)
	CSV = readCSV(new_path)
